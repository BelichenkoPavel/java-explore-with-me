...
public interface IHitDBRepository extends JpaRepository<Hit, Long> {
    ...
    public List<Stat> findByUriInUnique(String[] uris, LocalDateTime start, LocalDateTime end);
    ...
    public List<Stat> findGroupByUriIn(String[] uris, LocalDateTime start, LocalDateTime end);
